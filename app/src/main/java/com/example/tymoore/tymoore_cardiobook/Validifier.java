...
public class Validifier{
    ...
    public Validifier(Context context, String formattedDate, String formattedTime, String systolicString, String diastolicString, String heartRateString, String commentString) {
